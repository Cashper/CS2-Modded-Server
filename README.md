Credit goes to [Kus](https://github.com/kus/cs2-modded-server)
...
[CounterStrikeSharp](https://github.com/roflmuffin/CounterStrikeSharp) | `195` | Attempts to implement a .NET Core scripting layer on top of a Metamod Source Plugin, allowing developers to create plugins that interact with the game server in a modern language (C#)
